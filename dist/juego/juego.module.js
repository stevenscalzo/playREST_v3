...
const buscar_controller_1 = require("../buscar/buscar.controller");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                {
                    name: 'Juego',
                    schema: juego_schema_1.juegoSchema
                },
            ]),
        ],
        controllers: [juego_controller_1.JuegoController, buscar_controller_1.BuscarController],
